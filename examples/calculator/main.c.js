...
var lhs = calc.Block({
    ...
    In: {},
    Out: {
        value: calc.Out({ title: "LHS operand", descr: "LHS operand" })
    }
}, function (Mem, In, Out) {
...
}, function (In, Out) { return Out.value; }, function (Mem, value) {
...
var rhs = calc.Block({
    ...
    In: {},
    Out: {
        value: calc.Out({ title: "RHS operand", descr: "RHS operand" })
    }
}, function (Mem, In, Out) {
    Out.value.$ = decodeOperand(Mem.keyboard, Mem.initialValue);
})
...
}, function (In, Out) { return Out.value; }, function (Mem, n) {
...
var op = calc.Block({
    ...
    In: {},
    Out: {
        value: calc.Out({ title: "Operator", descr: "" }),
        symbol: calc.Out({ title: "Operator symbol", descr: "" })
    }
}, function (Mem, In, Out) {
    ...
    descr: ""
}, function (In, Out) { return Out.symbol; }, function (Mem, symbol) {
    Mem.display.innerHTML = symbol;
});
var calculator = calc.Block({
    title: "Calculator",
    ...
    In: {
        lhs: calc.In({ title: "A", descr: "First operand" }),
        rhs: calc.In({ title: "B", descr: "Second operand" }),
        op: calc.In({ title: "O", descr: "Operand" })
    },
    Out: {
        c: calc.Out({ title: "C", descr: "Result" })
    }
}, function (Mem, In, Out) {
    ...
    descr: ""
}, function (In, Out) { return Out.c; }, function (Mem, c) {
