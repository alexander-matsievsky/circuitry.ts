...
window.addEventListener("load", function () {
    ...
    var resource = todo.Block({
        ...
        Mem: lib_1.EMPTY_MEM,
        In: {
            restore: todo.In(DESCRIBE_LATER),
            POST: todo.In(DESCRIBE_LATER),
            PUT: todo.In(DESCRIBE_LATER),
            DELETE: todo.In(DESCRIBE_LATER)
        },
        Out: {
            GET: todo.Out(DESCRIBE_LATER),
            POST: todo.Out(DESCRIBE_LATER),
            PUT: todo.Out(DESCRIBE_LATER),
            DELETE: todo.Out(DESCRIBE_LATER)
        }
    }, function (Mem, In, Out) {
    ...
    var persistence = todo.Block({
        ...
        In: {
            store: todo.In(DESCRIBE_LATER)
        },
        Out: {
            restore: todo.Out(DESCRIBE_LATER)
        }
    }, function (Mem, In, Out) {
    ...
    var widget = todo.Block(DESCRIBE_LATER, {
        Mem: function () {
        ...
        Out: {
            POST: todo.Out(DESCRIBE_LATER),
            editing: todo.Out(DESCRIBE_LATER),
            PUT: todo.Out(DESCRIBE_LATER),
            DELETE: todo.Out(DESCRIBE_LATER),
            tab: todo.Out(DESCRIBE_LATER),
            filtered: todo.Out(DESCRIBE_LATER)
        }
    }, function (Mem, In, Out) {
        ...
        .Effect({
        title: "Todo POSTer",
        descr: "Creates a view for a newly posted todo. Every later update goes through PUTter."
        ...
        .Effect({
        title: "Todo PUTter",
        descr: "Updates a view for every todo update after POSTer."
...
var ERROR = {
    MUST_BE_IN_PORT: function (box, port) { return port + " in " + box.toString() + " must be of type `InPort`"; },
    MUST_BE_OUT_PORT: function (box, port) { return port + " in " + box.toString() + " must be of type `OutPort`"; },
    MUST_BELONG_TO_BOX: function (box, ports) { return "ports {" + ports.map(function (port) { return port.toString(); }).join("") + "} must belong to box " + box; }
};
...
var Descriptor = (function () {
    ...
    Object.defineProperty(Descriptor.prototype, "id", {
        get: function () {
            return this.id_;
        },
        enumerable: true,
    ...
    Object.defineProperty(Descriptor.prototype, "title", {
        get: function () {
            return this.title_;
        },
        enumerable: true,
    ...
    Object.defineProperty(Descriptor.prototype, "description", {
        get: function () {
...
var InPort = (function () {
    ...
    InPort.prototype.wire = function (that) {
        this.bus.plug(that);
    };
    return InPort;
})();
...
var OutPort = (function () {
    ...
    Object.defineProperty(OutPort.prototype, "wire", {
        get: function () {
            return this.bus;
        },
        enumerable: true,
...
var Block = (function () {
    ...
    Object.defineProperty(Block.prototype, "Out", {
        get: function () {
            return this.Out_;
        },
        enumerable: true,
...
var Circuit = (function () {
    function Circuit(descriptor) {
        this.blocks = {};
        this.wires = {};
        this.descriptor = new Descriptor(descriptor.title, descriptor.descr);
    }
    Circuit.prototype.In = function (descr) {
        return new InPort(new Descriptor(descr.title, descr.descr));
    };
    Circuit.prototype.Out = function (descr) {
        return new OutPort(new Descriptor(descr.title, descr.descr));
    };
